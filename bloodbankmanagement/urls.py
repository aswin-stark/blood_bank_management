...
urlpatterns = [
    ...
    path('adminlogin', never_cache(LoginView.as_view(template_name='blood/adminlogin.html')),name='adminlogin'),
    path('admin-dashboard', views.admin_dashboard_view,name='admin-dashboard'),
    path('admin-blood', views.admin_blood_view,name='admin-blood'),
    path('admin-giving', views.admin_giving_view,name='admin-giving'),
    path('admin-donor', views.admin_donor_view,name='admin-donor'),
    path('admin-donor/<int:pk>', views.donor_detail_view,name='donor-detail'),
    path('admin-donor/<int:pk>/toggle-status', views.toggle_donor_status_view,name='toggle-donor-status'),
    path('admin-patient', views.admin_patient_view,name='admin-patient'),
    path('admin-patient/<int:pk>', views.patient_detail_view,name='patient-detail'),
    path('admin-patient/<int:pk>/toggle-status', views.toggle_patient_status_view,name='toggle-patient-status'),
    ...
    path('admin-donation-history', views.admin_donation_history_view,name='admin-donation-history'),
